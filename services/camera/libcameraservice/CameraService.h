...
private:
    ...
    binder::Status connectHelper(const sp<CALLBACK>& cameraCb, const String8& cameraId,
            int api1CameraId, int halVersion, const String16& clientPackageNameMaybe, bool systemNativeClient,
    ...
    static binder::Status makeClient(const sp<CameraService>& cameraService,
            ...
            int halVersion, std::pair<int, IPCTransport> deviceVersionAndIPCTransport, apiLevel effectiveApiLevel,
